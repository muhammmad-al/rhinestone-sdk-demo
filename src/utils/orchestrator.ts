...
export const getBundle = async ({
  ...
  console.log("getBundle called with API key:", process.env.ORCHESTRATOR_API_KEY ? "Present" : "Missing");
  console.log("API key length:", process.env.ORCHESTRATOR_API_KEY?.length);
